/**
 * Ratuls_ACT - Browser Pixel & CAPI Bridge
 */
(function() {
    'use strict';

    if (typeof ratuls_act_config === 'undefined') return;
    const ST_Data = ratuls_act_config;
    ...
    document.addEventListener('click', function(e) {
        ...
        if (!btn) return;
        const eid = document.getElementById('ratuls-act-atc-event-id');
