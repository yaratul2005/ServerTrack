/**
 * Ratul_ACT - Browser Pixel & CAPI Bridge
 */
(function() {
    'use strict';

    if (typeof ratul_act_config === 'undefined') return;
    const ST_Data = ratul_act_config;
    ...
    document.addEventListener('click', function(e) {
        ...
        if (!btn) return;
        const eid = document.getElementById('ratul-ads-conversion-tracker-atc-event-id');
