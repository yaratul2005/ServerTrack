...
$ratuls_act_meta_configured   = get_option( 'ratuls_act_meta_enabled', 0 )
                        && get_option( 'ratuls_act_meta_pixel_id', '' )
                        && get_option( 'ratuls_act_meta_access_token', '' );
$ratuls_act_google_configured = get_option( 'ratuls_act_google_enabled', 0 )
                        && get_option( 'ratuls_act_google_refresh_token', '' );
$ratuls_act_tiktok_configured = get_option( 'ratuls_act_tiktok_enabled', 0 )
        ...
        <div class="st-platform-grid">
            ...
            <div class="st-platform-card">
                <div class="st-platform-card-header">
                    ...
                    <span class="st-status-pill <?php echo $ratuls_act_meta_configured ? 'st-status-ok' : ( get_option('ratuls_act_meta_enabled',0) ? 'st-status-warning' : 'st-status-inactive' ); ?>" id="st-health-pill-meta">
                        <span class="st-status-pill-dot"></span>
                        <?php echo $ratuls_act_meta_configured ? esc_html__( 'Active', 'servertrack' ) : ( get_option('ratuls_act_meta_enabled',0) ? esc_html__( 'Setup Required', 'servertrack' ) : esc_html__( 'Inactive', 'servertrack' ) ); ?>
                    </span>
                </div>
                <div class="st-platform-stats">
                    ...
                    <div class="st-platform-stat">
                        <div class="st-platform-stat-val"><?php echo $ratuls_act_meta_configured ? esc_html__( 'Connected', 'servertrack' ) : esc_html__( 'Not set', 'servertrack' ); ?></div>
            ...
            <div class="st-platform-card">
                <div class="st-platform-card-header">
                    ...
                    <span class="st-status-pill <?php echo $ratuls_act_google_configured ? 'st-status-ok' : ( get_option('ratuls_act_google_enabled',0) ? 'st-status-warning' : 'st-status-inactive' ); ?>" id="st-health-pill-google">
                        <span class="st-status-pill-dot"></span>
                        <?php echo $ratuls_act_google_configured ? esc_html__( 'Active', 'servertrack' ) : ( get_option('ratuls_act_google_enabled',0) ? esc_html__( 'Setup Required', 'servertrack' ) : esc_html__( 'Inactive', 'servertrack' ) ); ?>
                    </span>
                </div>
                <div class="st-platform-stats">
                    <div class="st-platform-stat">
                    ...
                    <div class="st-platform-stat">
                        <div class="st-platform-stat-val"><?php echo $ratuls_act_google_configured ? esc_html__( 'OAuth OK', 'servertrack' ) : esc_html__( 'Not set', 'servertrack' ); ?></div>
            ...
            <div class="st-platform-card">
                <div class="st-platform-card-header">
                    ...
                    <span class="st-status-pill <?php echo $ratuls_act_tiktok_configured ? 'st-status-ok' : ( get_option('ratuls_act_tiktok_enabled',0) ? 'st-status-warning' : 'st-status-inactive' ); ?>" id="st-health-pill-tiktok">
                        <span class="st-status-pill-dot"></span>
                        <?php echo $ratuls_act_tiktok_configured ? esc_html__( 'Active', 'servertrack' ) : ( get_option('ratuls_act_tiktok_enabled',0) ? esc_html__( 'Setup Required', 'servertrack' ) : esc_html__( 'Inactive', 'servertrack' ) ); ?>
                    </span>
                </div>
                <div class="st-platform-stats">
                    <div class="st-platform-stat">
                    ...
                    <div class="st-platform-stat">
                        <div class="st-platform-stat-val"><?php echo $ratuls_act_tiktok_configured ? esc_html__( 'Connected', 'servertrack' ) : esc_html__( 'Not set', 'servertrack' ); ?></div>
                        <div class="st-platform-stat-key"><?php esc_html_e( 'Token', 'servertrack' ); ?></div>
                    </div>
                </div>
