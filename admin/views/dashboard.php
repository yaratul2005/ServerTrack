...
$st_meta_configured   = get_option( 'ratuls_act_meta_enabled', 0 )
                        && get_option( 'ratuls_act_meta_pixel_id', '' )
                        && get_option( 'ratuls_act_meta_access_token', '' );
$st_google_configured = get_option( 'ratuls_act_google_enabled', 0 )
                        && get_option( 'ratuls_act_google_refresh_token', '' );
$st_tiktok_configured = get_option( 'ratuls_act_tiktok_enabled', 0 )
...
<div class="st-dashboard-grid">
    ...
    <div>
        <div class="st-card-title" style="margin-bottom:12px">
            ...
            <?php esc_html_e( 'Platform Status', 'ratuls-act' ); ?>
        </div>
            ...
            <div class="st-platform-card">
                <div class="st-platform-card-header">
                    <div class="st-platform-identity">
                        ...
                        <div>
                            <div class="st-platform-name"><?php esc_html_e( 'Meta CAPI', 'ratuls-act' ); ?></div>
                            <div class="st-platform-subtext"><?php esc_html_e( 'Conversions API', 'ratuls-act' ); ?></div>
                        </div>
                    </div>
                    <span class="st-status-pill <?php echo $st_meta_configured ? 'st-status-ok' : ( get_option('ratuls_act_meta_enabled',0) ? 'st-status-warning' : 'st-status-inactive' ); ?>" id="st-health-pill-meta">
                        <span class="st-status-pill-dot"></span>
                        <?php echo $st_meta_configured ? esc_html__( 'Active', 'ratuls-act' ) : ( get_option('ratuls_act_meta_enabled',0) ? esc_html__( 'Setup Required', 'ratuls-act' ) : esc_html__( 'Inactive', 'ratuls-act' ) ); ?>
                    </span>
                </div>
                <div class="st-platform-stats">
                    <div class="st-platform-stat">
                        <div class="st-platform-stat-val" id="st-last-send-meta"><?php esc_html_e( '—', 'ratuls-act' ); ?></div>
                        <div class="st-platform-stat-key"><?php esc_html_e( 'Last Send', 'ratuls-act' ); ?></div>
                    </div>
                    <div class="st-platform-stat">
                        <div class="st-platform-stat-val"><?php echo $st_meta_configured ? esc_html__( 'Connected', 'ratuls-act' ) : esc_html__( 'Not set', 'ratuls-act' ); ?></div>
                        <div class="st-platform-stat-key"><?php esc_html_e( 'Token', 'ratuls-act' ); ?></div>
                    </div>
                </div>
            ...
            <div class="st-platform-card">
                <div class="st-platform-card-header">
                    <div class="st-platform-identity">
                        ...
                        <div>
                            <div class="st-platform-name"><?php esc_html_e( 'Google Ads', 'ratuls-act' ); ?></div>
                            <div class="st-platform-subtext"><?php esc_html_e( 'Enhanced Conversions', 'ratuls-act' ); ?></div>
                        </div>
                    </div>
                    <span class="st-status-pill <?php echo $st_google_configured ? 'st-status-ok' : ( get_option('ratuls_act_google_enabled',0) ? 'st-status-warning' : 'st-status-inactive' ); ?>" id="st-health-pill-google">
                        <span class="st-status-pill-dot"></span>
                        <?php echo $st_google_configured ? esc_html__( 'Active', 'ratuls-act' ) : ( get_option('ratuls_act_google_enabled',0) ? esc_html__( 'Setup Required', 'ratuls-act' ) : esc_html__( 'Inactive', 'ratuls-act' ) ); ?>
                    </span>
                </div>
                <div class="st-platform-stats">
                    <div class="st-platform-stat">
                        <div class="st-platform-stat-val" id="st-last-send-google"><?php esc_html_e( '—', 'ratuls-act' ); ?></div>
                        <div class="st-platform-stat-key"><?php esc_html_e( 'Last Send', 'ratuls-act' ); ?></div>
                    </div>
                    <div class="st-platform-stat">
                        <div class="st-platform-stat-val"><?php echo $st_google_configured ? esc_html__( 'OAuth OK', 'ratuls-act' ) : esc_html__( 'Not set', 'ratuls-act' ); ?></div>
                        <div class="st-platform-stat-key"><?php esc_html_e( 'OAuth', 'ratuls-act' ); ?></div>
                    </div>
                </div>
            ...
            <div class="st-platform-card">
                <div class="st-platform-card-header">
                    <div class="st-platform-identity">
                        ...
                        <div>
                            <div class="st-platform-name"><?php esc_html_e( 'TikTok Events', 'ratuls-act' ); ?></div>
                            <div class="st-platform-subtext"><?php esc_html_e( 'Events API', 'ratuls-act' ); ?></div>
                        </div>
                    </div>
                    <span class="st-status-pill <?php echo $st_tiktok_configured ? 'st-status-ok' : ( get_option('ratuls_act_tiktok_enabled',0) ? 'st-status-warning' : 'st-status-inactive' ); ?>" id="st-health-pill-tiktok">
                        <span class="st-status-pill-dot"></span>
                        <?php echo $st_tiktok_configured ? esc_html__( 'Active', 'ratuls-act' ) : ( get_option('ratuls_act_tiktok_enabled',0) ? esc_html__( 'Setup Required', 'ratuls-act' ) : esc_html__( 'Inactive', 'ratuls-act' ) ); ?>
                    </span>
                </div>
                <div class="st-platform-stats">
                    <div class="st-platform-stat">
                        <div class="st-platform-stat-val" id="st-last-send-tiktok"><?php esc_html_e( '—', 'ratuls-act' ); ?></div>
                        <div class="st-platform-stat-key"><?php esc_html_e( 'Last Send', 'ratuls-act' ); ?></div>
                    </div>
                    <div class="st-platform-stat">
                        <div class="st-platform-stat-val"><?php echo $st_tiktok_configured ? esc_html__( 'Connected', 'ratuls-act' ) : esc_html__( 'Not set', 'ratuls-act' ); ?></div>
                        <div class="st-platform-stat-key"><?php esc_html_e( 'Token', 'ratuls-act' ); ?></div>
                    </div>
                </div>
    ...
    <div class="st-card">
        <h3 class="st-card-title">
            ...
            <?php esc_html_e( 'Recent Events', 'ratuls-act' ); ?>
        </h3>
        <ul class="st-activity-feed" id="st-activity-feed">
            <li class="st-loading-screen">
                <div class="st-spinner"></div>
                <div class="st-loading-text"><?php esc_html_e( 'Loading…', 'ratuls-act' ); ?></div>
            </li>
        </ul>
    </div>
