<?php
/**
 * Ratul_ACT — Dashboard Overview Tab  v2.3
 *
...
$ratul_act_meta_configured   = get_option( 'ratul_act_meta_enabled', 0 )
                        && get_option( 'ratul_act_meta_pixel_id', '' )
                        && get_option( 'ratul_act_meta_access_token', '' );
$ratul_act_google_configured = get_option( 'ratul_act_google_enabled', 0 )
                        && get_option( 'ratul_act_google_refresh_token', '' );
$ratul_act_tiktok_configured = get_option( 'ratul_act_tiktok_enabled', 0 )
...
<div class="st-dashboard-grid">
    ...
    <div>
        <div class="st-card-title" style="margin-bottom:12px">
            ...
            <?php esc_html_e( 'Platform Status', 'ratul-ads-conversion-tracker' ); ?>
        </div>
            ...
            <div class="st-platform-card">
                <div class="st-platform-card-header">
                    <div class="st-platform-identity">
                        ...
                        <div>
                            <div class="st-platform-name"><?php esc_html_e( 'Meta CAPI', 'ratul-ads-conversion-tracker' ); ?></div>
                            <div class="st-platform-subtext"><?php esc_html_e( 'Conversions API', 'ratul-ads-conversion-tracker' ); ?></div>
                        </div>
                    </div>
                    <span class="st-status-pill <?php echo $ratul_act_meta_configured ? 'st-status-ok' : ( get_option('ratul_act_meta_enabled',0) ? 'st-status-warning' : 'st-status-inactive' ); ?>" id="st-health-pill-meta">
                        <span class="st-status-pill-dot"></span>
                        <?php echo $ratul_act_meta_configured ? esc_html__( 'Active', 'ratul-ads-conversion-tracker' ) : ( get_option('ratul_act_meta_enabled',0) ? esc_html__( 'Setup Required', 'ratul-ads-conversion-tracker' ) : esc_html__( 'Inactive', 'ratul-ads-conversion-tracker' ) ); ?>
                    </span>
                </div>
                <div class="st-platform-stats">
                    <div class="st-platform-stat">
                        <div class="st-platform-stat-val" id="st-last-send-meta"><?php esc_html_e( '—', 'ratul-ads-conversion-tracker' ); ?></div>
                        <div class="st-platform-stat-key"><?php esc_html_e( 'Last Send', 'ratul-ads-conversion-tracker' ); ?></div>
                    </div>
                    <div class="st-platform-stat">
                        <div class="st-platform-stat-val"><?php echo $ratul_act_meta_configured ? esc_html__( 'Connected', 'ratul-ads-conversion-tracker' ) : esc_html__( 'Not set', 'ratul-ads-conversion-tracker' ); ?></div>
                        <div class="st-platform-stat-key"><?php esc_html_e( 'Token', 'ratul-ads-conversion-tracker' ); ?></div>
                    </div>
                </div>
                <button type="button" class="st-test-btn" data-platform="meta">
                    <svg viewBox="0 0 24 24"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>
                    <?php esc_html_e( 'Send Test → Meta', 'ratul-ads-conversion-tracker' ); ?>
                </button>
            ...
            <div class="st-platform-card">
                <div class="st-platform-card-header">
                    <div class="st-platform-identity">
                        ...
                        <div>
                            <div class="st-platform-name"><?php esc_html_e( 'Google Ads', 'ratul-ads-conversion-tracker' ); ?></div>
                            <div class="st-platform-subtext"><?php esc_html_e( 'Enhanced Conversions', 'ratul-ads-conversion-tracker' ); ?></div>
                        </div>
                    </div>
                    <span class="st-status-pill <?php echo $ratul_act_google_configured ? 'st-status-ok' : ( get_option('ratul_act_google_enabled',0) ? 'st-status-warning' : 'st-status-inactive' ); ?>" id="st-health-pill-google">
                        <span class="st-status-pill-dot"></span>
                        <?php echo $ratul_act_google_configured ? esc_html__( 'Active', 'ratul-ads-conversion-tracker' ) : ( get_option('ratul_act_google_enabled',0) ? esc_html__( 'Setup Required', 'ratul-ads-conversion-tracker' ) : esc_html__( 'Inactive', 'ratul-ads-conversion-tracker' ) ); ?>
                    </span>
                </div>
                <div class="st-platform-stats">
                    <div class="st-platform-stat">
                        <div class="st-platform-stat-val" id="st-last-send-google"><?php esc_html_e( '—', 'ratul-ads-conversion-tracker' ); ?></div>
                        <div class="st-platform-stat-key"><?php esc_html_e( 'Last Send', 'ratul-ads-conversion-tracker' ); ?></div>
                    </div>
                    <div class="st-platform-stat">
                        <div class="st-platform-stat-val"><?php echo $ratul_act_google_configured ? esc_html__( 'OAuth OK', 'ratul-ads-conversion-tracker' ) : esc_html__( 'Not set', 'ratul-ads-conversion-tracker' ); ?></div>
                        <div class="st-platform-stat-key"><?php esc_html_e( 'OAuth', 'ratul-ads-conversion-tracker' ); ?></div>
                    </div>
                </div>
                <button type="button" class="st-test-btn" data-platform="google">
                    <svg viewBox="0 0 24 24"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>
                    <?php esc_html_e( 'Send Test → Google', 'ratul-ads-conversion-tracker' ); ?>
                </button>
            ...
            <div class="st-platform-card">
                <div class="st-platform-card-header">
                    <div class="st-platform-identity">
                        ...
                        <div>
                            <div class="st-platform-name"><?php esc_html_e( 'TikTok Events', 'ratul-ads-conversion-tracker' ); ?></div>
                            <div class="st-platform-subtext"><?php esc_html_e( 'Events API', 'ratul-ads-conversion-tracker' ); ?></div>
                        </div>
                    </div>
                    <span class="st-status-pill <?php echo $ratul_act_tiktok_configured ? 'st-status-ok' : ( get_option('ratul_act_tiktok_enabled',0) ? 'st-status-warning' : 'st-status-inactive' ); ?>" id="st-health-pill-tiktok">
                        <span class="st-status-pill-dot"></span>
                        <?php echo $ratul_act_tiktok_configured ? esc_html__( 'Active', 'ratul-ads-conversion-tracker' ) : ( get_option('ratul_act_tiktok_enabled',0) ? esc_html__( 'Setup Required', 'ratul-ads-conversion-tracker' ) : esc_html__( 'Inactive', 'ratul-ads-conversion-tracker' ) ); ?>
                    </span>
                </div>
                <div class="st-platform-stats">
                    <div class="st-platform-stat">
                        <div class="st-platform-stat-val" id="st-last-send-tiktok"><?php esc_html_e( '—', 'ratul-ads-conversion-tracker' ); ?></div>
                        <div class="st-platform-stat-key"><?php esc_html_e( 'Last Send', 'ratul-ads-conversion-tracker' ); ?></div>
                    </div>
                    <div class="st-platform-stat">
                        <div class="st-platform-stat-val"><?php echo $ratul_act_tiktok_configured ? esc_html__( 'Connected', 'ratul-ads-conversion-tracker' ) : esc_html__( 'Not set', 'ratul-ads-conversion-tracker' ); ?></div>
                        <div class="st-platform-stat-key"><?php esc_html_e( 'Token', 'ratul-ads-conversion-tracker' ); ?></div>
                    </div>
                </div>
                <button type="button" class="st-test-btn" data-platform="tiktok">
                    <svg viewBox="0 0 24 24"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>
                    <?php esc_html_e( 'Send Test → TikTok', 'ratul-ads-conversion-tracker' ); ?>
                </button>
    ...
    <div class="st-card">
        <h3 class="st-card-title">
            ...
            <?php esc_html_e( 'Recent Events', 'ratul-ads-conversion-tracker' ); ?>
        </h3>
        <ul class="st-activity-feed" id="st-activity-feed">
            <li class="st-loading-screen">
                <div class="st-spinner"></div>
                <div class="st-loading-text"><?php esc_html_e( 'Loading…', 'ratul-ads-conversion-tracker' ); ?></div>
            </li>
        </ul>
    </div>
