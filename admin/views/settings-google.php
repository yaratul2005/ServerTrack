...
<table class="form-table" role="presentation">
    ...
    <div class="st-toggle" style="margin-right:12px;">
        <input type="checkbox" name="ratuls_act_google_enabled" value="1"
    ...
    <div id="st-google-fields" style="<?php echo get_option( 'ratuls_act_google_enabled', 0 ) ? '' : 'display:none'; ?>">

        <!-- ── OAuth Status Card ─────────────────────────────────────────── -->
        <?php
        $access_token  = get_option( 'ratuls_act_google_access_token', '' );
        $token_expires = (int) get_option( 'ratuls_act_google_token_expires', 0 );
        ...
        <div class="st-oauth-card <?php echo $is_connected ? 'st-oauth-card--connected' : 'st-oauth-card--disconnected'; ?>">
            ...
            <div class="st-oauth-card__body">
                ...
                <?php else : ?>
                    ...
                    $redirect_uri  = admin_url( 'options-general.php?page=ratuls-act&tab=google' );
    ...
    <span class="st-toggle-text" style="font-weight:500;"><?php esc_html_e( 'Grant ad_user_data by default', 'ratuls-act' ); ?></span>
                        ...
                        <label class="st-toggle-label st-row" style="cursor:pointer; display:flex; align-items:center;">
    <div class="st-toggle" style="margin-right:12px;">
        <input type="checkbox" name="ratuls_act_google_consent_ad_personalization" value="1"
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="st_google_client_id"
                           ...
                           value="<?php echo esc_attr( get_option( 'ratuls_act_google_client_id', '' ) ); ?>"
            ...
            <tr>
                ...
                <td>
                    <input type="password" id="st_google_client_secret"
                           ...
                           value="<?php echo esc_attr( get_option( 'ratuls_act_google_client_secret', '' ) ); ?>"
                           class="regular-text st-field-input" autocomplete="new-password">
                </td>
            </tr>
