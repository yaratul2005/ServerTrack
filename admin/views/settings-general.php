...
<table class="form-table" role="presentation">
    ...
    <tr>
        <th scope="row"><label for="ratuls_act_consent_mode"><?php esc_html_e( 'Consent Mode', 'servertrack' ); ?></label></th>
        <td>
            <select class="st-field-select" id="ratuls_act_consent_mode" name="ratuls_act_consent_mode">
                ...
                $options = [
                    ...
                    'manual'     => __( 'Manual (use ratuls_act_consent_granted filter)', 'servertrack' ),
                ];
