...
<form method="post" action="options.php">
    ...
    <table class="form-table" role="presentation">
        <tr>
            ...
            <td>
                <label>
                    <input type="checkbox" name="servertrack_meta_enabled" value="1" <?php checked( 1, get_option( 'servertrack_meta_enabled', 0 ) ); ?> />
        ...
        <tr>
            ...
            <td>
                <input type="text" id="servertrack_meta_pixel_id" name="servertrack_meta_pixel_id"
        ...
        <tr>
            ...
            <td>
                <input type="password" id="servertrack_meta_access_token" name="servertrack_meta_access_token"
        ...
        <tr>
            ...
            <td>
                <input type="text" id="servertrack_meta_test_event_code" name="servertrack_meta_test_event_code"
...
<p><?php esc_html_e( 'Sends a dummy Lead event to Meta CAPI to verify your credentials.', 'servertrack' ); ?></p>
