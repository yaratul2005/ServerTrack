...
/**
 * Meta CAPI tab — uses its own option group: servertrack_meta_settings
 * Saving this tab ONLY saves Meta options. Other tabs are unaffected.
 */
?>
<form method="post" action="options.php">
    <?php settings_fields( 'servertrack_meta_settings' ); ?>
    ...
    <?php submit_button( __( 'Save Meta Settings', 'servertrack' ) ); ?>
</form>
<hr />
