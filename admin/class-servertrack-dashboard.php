...
class ServerTrack_Dashboard {
        ...
        <div class="st-panel">
            <div class="st-panel-header">
                <span class="st-panel-title">
                    ...
                    Live Event Log
                    <span style="font-weight:400;color:var(--st-faint);font-size:12px;margin-left:6px;">last 200 &middot; auto-refreshes every 30s</span>
            ...
            <div class="st-filter-bar">
                ...
                <input type="text" id="st-fe" placeholder="Search event&hellip;" oninput="stFilter()" style="min-width:160px;">
                <input type="text" id="st-fo" placeholder="Order #&hellip;" oninput="stFilter()" style="width:100px;">
            </div>
    ...
    public static function render_log_rows( array $logs ): void {
        ...
        foreach ( $logs as $entry ) {
            ...
            $icon = $status_icons[ $status ] ?? '<span style="width:13px;display:inline-block;">&bull;</span>';
