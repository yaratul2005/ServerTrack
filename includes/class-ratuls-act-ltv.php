<?php
/**
 * Ratuls_ACT — Customer LTV Signal in Purchase Payload (Feature #6)
 *
...
class Ratuls_ACT_LTV {

	/**
	 * Register filter hooks.
	 */
	public static function init(): void {
		add_filter( 'ratuls_act_purchase_custom_data', [ __CLASS__, 'enrich_custom_data' ], 10, 2 );
	}
	...
	public static function calculate_ltv( WC_Order $order ): array {
		...
		return apply_filters( 'ratuls_act_ltv_data', $ltv_data, $order, $historical_value );
	}
