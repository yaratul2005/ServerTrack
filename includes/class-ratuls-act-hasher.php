...
class Ratuls_ACT_Hasher {
     ...
     * to Ratuls_ACT_Dedup::generate_event_id() for the final hash/UUID output.
     *
     * Called by Ratuls_ACT_Source_WooCommerce for all 10 CAPI events:
    ...
    public static function event_id( string $event_name, $context ): string {
        ...
        return Ratuls_ACT_Dedup::generate_event_id( $seed );
    }
}
