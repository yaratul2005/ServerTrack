<?php
/**
 * Ratul_ACT — Customer LTV Signal in Purchase Payload (Feature #6)
 *
...
class Ratul_ACT_LTV {
	...
	public static function init(): void {
		add_filter( 'ratul_act_purchase_custom_data', [ __CLASS__, 'enrich_custom_data' ], 10, 2 );
	}
	...
	public static function calculate_ltv( WC_Order $order ): array {
		...
		return apply_filters( 'ratul_act_ltv_data', $ltv_data, $order, $historical_value );
	}
