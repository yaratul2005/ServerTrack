...
class Ratul_ACT_Hasher {
     ...
     * to Ratul_ACT_Dedup::generate_event_id() for the final hash/UUID output.
     *
     * Called by Ratul_ACT_Source_WooCommerce for all 10 CAPI events:
    ...
    public static function event_id( string $event_name, $context ): string {
        ...
        return Ratul_ACT_Dedup::generate_event_id( $seed );
    }
}
