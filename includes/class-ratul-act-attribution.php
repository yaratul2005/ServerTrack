...
class Ratul_ACT_Attribution {
    ...
    public static function init(): void {
        ...
        add_filter( 'ratul_act_event_custom_data', [ self::class, 'append_attribution_to_event' ], 10, 2 );
    }
    ...
    public static function append_attribution_to_event( array $custom_data, Ratul_ACT_Event $event ): array {
