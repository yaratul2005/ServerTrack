...
class Ratul_ACT_Proxy {
    ...
    public static function register_routes(): void {
        register_rest_route( 'ratul-ads-conversion-tracker/v1', '/pixel/(?P<platform>[a-zA-Z0-9-]+)', [
            'methods'             => 'POST',
    ...
    public static function handle_pixel_payload( WP_REST_Request $request ) {
        ...
        // Apply rate limit
        $ip = Ratul_ACT_Frontend::get_request_ip();
        ...
        $event_id   = sanitize_text_field( $body['event_id'] ?? Ratul_ACT_Dedup::generate_event_id() );
        ...
        // Dispatch
        if ( get_option( 'ratul_act_' . $platform . '_enabled', 0 ) && Ratul_ACT_Consent::is_granted( $platform ) ) {
