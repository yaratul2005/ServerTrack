...
class Ratuls_ACT_TikTok {
    ...
    public static function send( Ratuls_ACT_Event $event ): array {
        ...
        $pixel_id     = trim( (string) get_option( 'ratuls_act_tiktok_pixel_id', '' ) );
        $access_token = trim( (string) get_option( 'ratuls_act_tiktok_access_token', '' ) );
