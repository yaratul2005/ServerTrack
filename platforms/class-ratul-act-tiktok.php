...
class Ratul_ACT_TikTok {
    ...
    public static function send( Ratul_ACT_Event $event ): array {
        ...
        $pixel_id     = trim( (string) get_option( 'ratul_act_tiktok_pixel_id', '' ) );
        $access_token = trim( (string) get_option( 'ratul_act_tiktok_access_token', '' ) );
