...
class WooCommerceAddToCartTest extends TestCase {
    ...
    public function test_add_to_cart_dispatches_event(): void {
        ...
        Ratul_ACT_Source_WooCommerce::handle_add_to_cart(
            'cart_key_abc', 77, 2, 0, [], []
        );

        $this->assertCount( 1, Ratul_ACT_Core::$dispatched );
        $this->assertSame( 'AddToCart', Ratul_ACT_Core::$dispatched[0]['event'] );
    }
    ...
    public function test_add_to_cart_content_ids_contains_product_id(): void {
        ...
        $this->assertSame( [ '77' ], Ratul_ACT_Core::$dispatched[0]['custom']['content_ids'] );
    }
